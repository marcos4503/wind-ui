//Component "CodeBlock" JavaScript Code
/*
...
class CodeBlock {
    static updateAllColorsOfAllCodeBlocks() {
        //Colorize all blocks of Rainbow Sintax Highlighter third party library, after load a fragment
        Rainbow.color();
    }
}