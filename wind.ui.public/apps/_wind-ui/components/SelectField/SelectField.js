//Component "SelectField" JavaScript Code
/*
...
class SelectField {
    ...
    //Validate a SelectField component and show status
    static autoValidation(targetInput) {
        //Get metadata of field
        var id = targetInput.parentNode.id;
        var value = targetInput.options[targetInput.selectedIndex].value;
        ...
        if (allowempty == "false" && value == "")
            isValid = "- Por favor, selecione uma opção válida.";
    ...
    //Check if a SelectField is valid
    ...
    //Get selected option index of SelectField
    static getSelectedOptionIndex(componentId) {
        //Access the component
        var component = WindUiJs.getComponentById(componentId + "Input");
        if (component != null) {
    ...
    static forceValidate(componentId) {
        ...
        if (component != null) {
            //Validate the field
            SelectField.autoValidation(component);
        }
    }
    ...
    static setStatus(componentId, isGood, message) {
        ...
        if (componentInput != null && componentStatus != null) {
            //Force the field to validate
            SelectField.forceValidate(componentId);
