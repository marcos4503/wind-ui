//Component "FloatField" JavaScript Code
/*
...
class FloatField {
    ...
    //Auto hide characters count of FloatField
    ...
    //Auto show characters count of FloatField
    static autoShowCharCount(targetInput) {
        ...
        FloatField.autoUpdateCharCount(charCount, value, maxchars, "red", "");
    }
    ...
    //Validate a FloatField component and show status
    ...
    //Check if a FloatField is valid
    ...
    //Set a text in FloatField
    static setNumber(componentId, newNumber) {
        //Access the component
        var component = WindUiJs.getComponentById(componentId + "Input");
        if (component != null) {
            //Change the text
            if (WindUiJs.isFloat(newNumber) == true)
                component.value = newNumber;
        }
    }

    //Get current number in FloatField
    static getNumber(componentId) {
        //Access the component
        var component = WindUiJs.getComponentById(componentId + "Input");
        if (component != null) {
            //Change the text
            return parseFloat(component.value);
        }
    }
    ...
    static forceValidate(componentId) {
        ...
        if (component != null) {
            //Validate the field
            FloatField.autoValidation(component);
        }
    }
    ...
    static setStatus(componentId, isGood, message) {
        ...
        if (componentInput != null && componentStatus != null) {
            //Force the field to validate
            FloatField.forceValidate(componentId);
